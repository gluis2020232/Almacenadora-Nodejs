...
const TablaPosiciones = require('../models/tablaPosiciones.model');
//const Admin = require('../models/usuario.model');

function verTablaPosiciones(req, res) {
    TablaPosiciones.find({}, (err, tposicionesEncontrados) => {

        return res.send({ tposiciones: tposicionesEncontrados })
    })
}
